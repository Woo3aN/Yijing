#!/usr/bin/env python3
"""生成完整的 hexagrams.json —— 64卦周易原文数据"""
...
# ============================================================
# 64卦完整数据
# 每卦: (number, name, pinyin, symbol, upper_trigram, lower_trigram,
#         judgment, tuan_zhuan, xiang_zhuan, [lines...])
# line: (position, label, text, xiang)
# ============================================================
...
def H(num, lower, upper, name, pinyin, symbol, judgment, tuan, xiang, lines):
    """构建一个卦的数据"""
    # binary: lower trigram (bottom 3) + upper trigram (top 3), bottom-to-top
    lower_bin = TRIGRAMS[lower]["binary"]
    upper_bin = TRIGRAMS[upper]["binary"]
    binary = lower_bin + upper_bin  # bottom-to-top: lines 1,2,3,4,5,6
    return {
        "number": num,
        "binary": binary,
        "name": name,
        ...
        "tuan_zhuan": tuan,
        "xiang_zhuan": xiang,
        "lines": [{"position": _LINE_POS[l], "label": l, "text": t, "xiang": x}
                   for l, t, x in lines]
    }
...
# 1. 乾为天
HEXAGRAMS.append(H(1, "乾", "乾", "乾", "qián", "䷀",
    "元亨利贞。",
...
# 2. 坤为地
HEXAGRAMS.append(H(2, "坤", "坤", "坤", "kūn", "䷁",
...
# 3. 水雷屯
HEXAGRAMS.append(H(3, "震", "坎", "屯", "zhūn", "䷂",
    "元亨利贞。勿用有攸往，利建侯。",
    ...
    [("初九","磐桓，利居贞，利建侯。","《象》曰：虽磐桓，志行正也。以贵下贱，大得民也。"),
     ...
     ("六四","乘马班如，求婚媾，往吉无不利。","《象》曰：求而往，明也。"),
     ("九五","屯其膏，小贞吉，大贞凶。","《象》曰：屯其膏，施未光也。"),
     ("上六","乘马班如，泣血涟如。","《象》曰：泣血涟如，何可长也。")]
))

# 4. 山水蒙
HEXAGRAMS.append(H(4, "坎", "艮", "蒙", "méng", "䷃",
...
# 6. 天水讼
HEXAGRAMS.append(H(6, "坎", "乾", "讼", "sòng", "䷅",
    ...
    [("初六","不永所事，小有言，终吉。","《象》曰：不永所事，讼不可长也。虽小有言，其辩明也。"),
     ...
     ("九四","不克讼，复即命，渝安贞，吉。","《象》曰：复即命渝，安贞不失也。"),
     ("九五","讼，元吉。","《象》曰：讼元吉，以中正也。"),
     ("上九","或锡之鞶带，终朝三褫之。","《象》曰：以讼受服，亦不足敬也。")]
))

# 7. 地水师
HEXAGRAMS.append(H(7, "坎", "坤", "师", "shī", "䷆",
    "贞，丈人吉，无咎。",
...
# 9. 风天小畜
HEXAGRAMS.append(H(9, "乾", "巽", "小畜", "xiǎo xù", "䷈",
    "亨。密云不雨，自我西郊。",
...
# 10. 天泽履
HEXAGRAMS.append(H(10, "兑", "乾", "履", "lǚ", "䷉",
    "履虎尾，不咥人，亨。",
...
# 11. 地天泰
HEXAGRAMS.append(H(11, "乾", "坤", "泰", "tài", "䷊",
    "小往大来，吉亨。",
...
# 12. 天地否
HEXAGRAMS.append(H(12, "坤", "乾", "否", "pǐ", "䷋",
    "否之匪人，不利君子贞。大往小来。",
...
# 13. 天火同人
HEXAGRAMS.append(H(13, "离", "乾", "同人", "tóng rén", "䷌",
    "同人于野，亨。利涉大川，利君子贞。",
    ...
    [("初九","同人于门，无咎。","《象》曰：出门同人，又谁咎也。"),
     ...
     ("九五","同人先号咷而后笑，大师克相遇。","《象》曰：同人之先，以中直也。大师相遇，言相克也。"),
     ("上九","同人于郊，无悔。","《象》曰：同人于郊，志未得也。")]
))

# 14. 火天大有
HEXAGRAMS.append(H(14, "乾", "离", "大有", "dà yǒu", "䷍",
    "元亨。",
...
# 16. 雷地豫
HEXAGRAMS.append(H(16, "坤", "震", "豫", "yù", "䷏",
    "利建侯行师。",
...
# 17. 泽雷随
HEXAGRAMS.append(H(17, "震", "兑", "随", "suí", "䷐",
    "元亨利贞，无咎。",
...
# 18. 山风蛊
HEXAGRAMS.append(H(18, "巽", "艮", "蛊", "gǔ", "䷑",
    "元亨，利涉大川。先甲三日，后甲三日。",
...
# 19. 地泽临
HEXAGRAMS.append(H(19, "兑", "坤", "临", "lín", "䷒",
    "元亨利贞。至于八月有凶。",
...
# 20. 风地观
HEXAGRAMS.append(H(20, "坤", "巽", "观", "guān", "䷓",
    "盥而不荐，有孚颙若。",
...
# 21. 火雷噬嗑
HEXAGRAMS.append(H(21, "震", "离", "噬嗑", "shì kè", "䷔",
    "亨。利用狱。",
...
# 22. 山火贲
HEXAGRAMS.append(H(22, "离", "艮", "贲", "bì", "䷕",
    "亨。小利有攸往。",
    ...
    [("初九","贲其趾，舍车而徒。","《象》曰：舍车而徒，义弗乘也。"),
     ...
     ("六四","贲如皤如，白马翰如，匪寇婚媾。","《象》曰：六四当位，疑也。匪寇婚媾，终无尤也。"),
     ("六五","贲于丘园，束帛戋戋，吝，终吉。","《象》曰：六五之吉，有喜也。"),
     ("上九","白贲，无咎。","《象》曰：白贲无咎，上得志也。")]
))

# 23. 山地剥
HEXAGRAMS.append(H(23, "坤", "艮", "剥", "bō", "䷖",
    "不利有攸往。",
...
# 24. 地雷复
HEXAGRAMS.append(H(24, "震", "坤", "复", "fù", "䷗",
...
# 25. 天雷无妄
HEXAGRAMS.append(H(25, "震", "乾", "无妄", "wú wàng", "䷘",
    "元亨利贞。其匪正有眚，不利有攸往。",
...
# 26. 山天大畜
HEXAGRAMS.append(H(26, "乾", "艮", "大畜", "dà chù", "䷙",
    "利贞。不家食吉，利涉大川。",
...
# 27. 山雷颐
HEXAGRAMS.append(H(27, "震", "艮", "颐", "yí", "䷚",
    "贞吉。观颐，自求口实。",
...
# 28. 泽风大过
HEXAGRAMS.append(H(28, "巽", "兑", "大过", "dà guò", "䷛",
    "栋桡，利有攸往，亨。",
...
# 29. 坎为水
HEXAGRAMS.append(H(29, "坎", "坎", "坎", "kǎn", "䷜",
    "习坎，有孚，维心亨，行有尚。",
    ...
    [("初六","习坎，入于坎窞，凶。","《象》曰：习坎入坎，失道凶也。"),
     ...
     ("上六","系用徽纆，置于丛棘，三岁不得，凶。","《象》曰：上六失道，凶三岁也。")]
))

# 30. 离为火
HEXAGRAMS.append(H(30, "离", "离", "离", "lí", "䷝",
    "利贞，亨。畜牝牛，吉。",
...
# 31. 泽山咸
HEXAGRAMS.append(H(31, "艮", "兑", "咸", "xián", "䷞",
    "亨，利贞。取女吉。",
...
# 32. 雷风恒
HEXAGRAMS.append(H(32, "巽", "震", "恒", "héng", "䷟",
    "亨，无咎，利贞。利有攸往。",
...
# 33. 天山遯
HEXAGRAMS.append(H(33, "艮", "乾", "遯", "dùn", "䷠",
    "亨，小利贞。",
...
# 34. 雷天大壮
HEXAGRAMS.append(H(34, "乾", "震", "大壮", "dà zhuàng", "䷡",
    "利贞。",
    ...
    [("初九","壮于趾，征凶，有孚。","《象》曰：壮于趾，其孚穷也。"),
     ...
     ("上六","羝羊触藩，不能退，不能遂，无攸利，艰则吉。","《象》曰：不能退不能遂，不详也。艰则吉，咎不长也。")]
))

# 35. 火地晋
HEXAGRAMS.append(H(35, "坤", "离", "晋", "jìn", "䷢",
    "康侯用锡马蕃庶，昼日三接。",
...
# 36. 地火明夷
HEXAGRAMS.append(H(36, "离", "坤", "明夷", "míng yí", "䷣",
    "利艰贞。",
...
# 37. 风火家人
HEXAGRAMS.append(H(37, "离", "巽", "家人", "jiā rén", "䷤",
    "利女贞。",
...
# 38. 火泽睽
HEXAGRAMS.append(H(38, "兑", "离", "睽", "kuí", "䷥",
    "小事吉。",
...
# 39. 水山蹇
HEXAGRAMS.append(H(39, "艮", "坎", "蹇", "jiǎn", "䷦",
    "利西南，不利东北。利见大人，贞吉。",
...
# 40. 雷水解
HEXAGRAMS.append(H(40, "坎", "震", "解", "xiè", "䷧",
    "利西南。无所往，其来复吉。有攸往，夙吉。",
...
# 41. 山泽损
HEXAGRAMS.append(H(41, "兑", "艮", "损", "sǔn", "䷨",
    "有孚，元吉，无咎，可贞。利有攸往。曷之用？二簋可用享。",
    "《彖》曰：损，损下益上，其道上行。损而有孚，元吉无咎可贞，利有攸往。曷之用？二簋可用享。二簋应有时，损刚益柔有时。损益盈虚，与时偕行。",
    "《象》曰：山下有泽，损。君子以惩忿窒欲。",
...
# 42. 风雷益
HEXAGRAMS.append(H(42, "震", "巽", "益", "yì", "䷩",
    "利有攸往，利涉大川。",
...
# 43. 泽天夬
HEXAGRAMS.append(H(43, "乾", "兑", "夬", "guài", "䷪",
...
# 44. 天风姤
HEXAGRAMS.append(H(44, "巽", "乾", "姤", "gòu", "䷫",
    "女壮，勿用取女。",
...
# 45. 泽地萃
HEXAGRAMS.append(H(45, "坤", "兑", "萃", "cuì", "䷬",
...
# 46. 地风升
HEXAGRAMS.append(H(46, "巽", "坤", "升", "shēng", "䷭",
    "元亨。用见大人，勿恤。南征吉。",
...
# 48. 水风井
HEXAGRAMS.append(H(48, "巽", "坎", "井", "jǐng", "䷯",
...
# 49. 泽火革
HEXAGRAMS.append(H(49, "离", "兑", "革", "gé", "䷰",
    "己日乃孚。元亨利贞，悔亡。",
...
# 50. 火风鼎
HEXAGRAMS.append(H(50, "巽", "离", "鼎", "dǐng", "䷱",
    "元吉，亨。",
...
# 51. 震为雷
HEXAGRAMS.append(H(51, "震", "震", "震", "zhèn", "䷲",
...
# 52. 艮为山
HEXAGRAMS.append(H(52, "艮", "艮", "艮", "gèn", "䷳",
...
# 53. 风山渐
HEXAGRAMS.append(H(53, "艮", "巽", "渐", "jiàn", "䷴",
    "女归吉，利贞。",
...
# 54. 雷泽归妹
HEXAGRAMS.append(H(54, "兑", "震", "归妹", "guī mèi", "䷵",
    "征凶，无攸利。",
...
# 55. 雷火丰
HEXAGRAMS.append(H(55, "离", "震", "丰", "fēng", "䷶",
    "亨，王假之。勿忧，宜日中。",
    ...
    [("初九","遇其配主，虽旬无咎，往有尚。","《象》曰：虽旬无咎，过旬灾也。"),
     ...
     ("上六","丰其屋，蔀其家，窥其户，阒其无人，三岁不觌，凶。","《象》曰：丰其屋，天际翔也。窥其户阒其无人，自藏也。")]
))

# 56. 火山旅
HEXAGRAMS.append(H(56, "艮", "离", "旅", "lǚ", "䷷",
    "小亨，旅贞吉。",
...
# 57. 巽为风
HEXAGRAMS.append(H(57, "巽", "巽", "巽", "xùn", "䷸",
    "小亨，利有攸往，利见大人。",
...
# 58. 兑为泽
HEXAGRAMS.append(H(58, "兑", "兑", "兑", "duì", "䷹",
    "亨，利贞。",
...
# 59. 风水涣
HEXAGRAMS.append(H(59, "坎", "巽", "涣", "huàn", "䷺",
    "亨。王假有庙。利涉大川，利贞。",
...
# 60. 水泽节
HEXAGRAMS.append(H(60, "兑", "坎", "节", "jié", "䷻",
    "亨。苦节不可贞。",
...
# 61. 风泽中孚
HEXAGRAMS.append(H(61, "兑", "巽", "中孚", "zhōng fú", "䷼",
    "豚鱼吉。利涉大川，利贞。",
...
# 62. 雷山小过
HEXAGRAMS.append(H(62, "艮", "震", "小过", "xiǎo guò", "䷽",
...
# 63. 水火既济
HEXAGRAMS.append(H(63, "离", "坎", "既济", "jì jì", "䷾",
    "亨小，利贞。初吉终乱。",
...
# 64. 火水未济
HEXAGRAMS.append(H(64, "坎", "离", "未济", "wèi jì", "䷿",
    "亨。小狐汔济，濡其尾，无攸利。",
    ...
    [("初六","濡其尾，吝。","《象》曰：濡其尾，亦不知极也。"),
     ...
     ("九四","贞吉悔亡。震用伐鬼方，三年有赏于大国。","《象》曰：贞吉悔亡，志行也。"),
     ("六五","贞吉无悔。君子之光，有孚，吉。","《象》曰：君子之光，其晖吉也。"),
...
if __name__ == "__main__":
    output_path = os.path.join(os.path.dirname(__file__), "hexagrams.json")
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(HEXAGRAMS, f, ensure_ascii=False, indent=2)
    print(f"已生成 hexagrams.json，包含 {len(HEXAGRAMS)} 个卦")
